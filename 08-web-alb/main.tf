...
## Creating AWS Load Balaner Listener for HTTP
...
## Creating AWS Load Balaner Listener for HTTPS
...
## Creating AWS Route 53 records for web Load Balancer
