...
## Creating null resource to perform some operations on the frontend instances once created.
...
## Creating AWS Load Balancer Target Group
...
## Creating autoscaling policy for frontend
...
## Creating load balancer listener for frontend
